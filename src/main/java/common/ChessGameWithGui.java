...
public class ChessGameWithGui {
    ...
    public ChessGameWithGui(Player whitePlayer, Player blackPlayer, PiecesMetadata metadata, IMoveHandler moveHandler, StateChecker stateChecker) {
